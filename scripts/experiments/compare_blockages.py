"""Run the original DMVCS experiment with the reorganized package."""
...
import numpy as np
import random
from dmvcs.algorithms import admm as ADMM_function
import matplotlib.pyplot as plt
from matplotlib.ticker import MultipleLocator


def main() -> None:
    """Run the original experiment from the repository root."""
